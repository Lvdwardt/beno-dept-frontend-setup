import OldButton from '../components/Button/Old-setup-button'
import { button, Button as ReactButton } from '../components/Button/React-setup-button'
        ...
        <div className="space-y-12">
          ...
          <section>
            ...
            <div className="mb-8">
              ...
              <div className="flex flex-wrap gap-4">
                <OldButton
                  label="Click Me!"
                  variant="primary"
                  data-on-click="button::click(clicked)"
                />
              </div>
            </div>
            ...
            <div>
              <h3 className="mb-4 text-lg font-medium text-gray-700">React Setup Button</h3>
              <div className="flex flex-wrap gap-4">
                <ReactButton variant="primary" data-on-click="button::click(react-clicked)">
                  Click Me!
                </ReactButton>
              </div>
            </div>
